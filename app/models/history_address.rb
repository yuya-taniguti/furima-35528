class HistoryAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, regional_id: regional_id, municipality: municipality, address: address,
                   phone_number: phone_number, building_name: building_name, history_id: history.id)
  end
end
